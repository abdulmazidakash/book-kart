    ...
    <main className="min-h-screen">
      <section className="relative h-[600px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-white text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-8">Buy and Sell old Books online in Bangladesh</h1>
        ...
        <section className="py-16 bg-amber-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-4">
              <h2 className="text-3xl font-bold mb-4">How to Sell Old Books online on BookKart?</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">Saving good amount of money by buying used books is just 3 steps away from you:</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              {sellSteps.map((step, index) => (
                <div key={index} className="relative flex flex-col h-full">
                  <div className="bg-white rounded-xl p-8 shadow-lg text-center flex-grow flex flex-col relative">
                    {/* Step Number */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              {buySteps.map((step, index) => (
                <div key={index} className="relative flex flex-col h-full">
                  <div className="bg-yellow-400 rounded-xl p-8 shadow-lg text-center flex-grow flex flex-col relative">
                    {/* Step Number */}
        ...
        <section className="py-16 bg-[rgb(221,234,254)]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {blogPosts.map((post, index)=>(
              <Card 
              key={index}
              className="h-full flex flex-col overflow-hidden transition-all py-0 duration-300 hover:shadow-lg"
              >
